...
const FilterPage = () => {
  ...
  return (
    <div className="w-full md:w-72 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 h-fit">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">by Cuisines</p>
          </div>
        </div>
