    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="bg-white dark:bg-gray-800 rounded-2xl border-none shadow-2xl max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/40 rounded-xl p-4 mb-2 border border-gray-100 dark:border-gray-700">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-3 text-sm uppercase tracking-wide text-gray-500 dark:text-gray-400">
            Order Summary
          </h3>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              name="email"
              value={input.email}
              className="bg-gray-100 dark:bg-gray-700 text-gray-500 cursor-not-allowed rounded-lg"
            />
          </div>
          ...
          <div className="space-y-2">
            <Label className="flex items-center gap-1.5 text-gray-700 dark:text-gray-300 font-medium">
          ...
          <DialogFooter className="col-span-1 md:col-span-2 pt-4">
            {loading ? (
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 h-12 text-white font-semibold rounded-lg shadow-md shadow-orange-500/20"
              >
